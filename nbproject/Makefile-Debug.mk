...
${OBJECTDIR}/fonctionsGestionCases.o: fonctionsGestionCases.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fonctionsGestionCases.o fonctionsGestionCases.c

${OBJECTDIR}/fonctionsGestionMenu.o: fonctionsGestionMenu.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fonctionsGestionMenu.o fonctionsGestionMenu.c

${OBJECTDIR}/fonctionsGestionMouvements.o: fonctionsGestionMouvements.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fonctionsGestionMouvements.o fonctionsGestionMouvements.c
